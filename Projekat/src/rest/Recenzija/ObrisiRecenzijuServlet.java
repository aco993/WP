...
/**
 * Servlet implementation class ObrisiRecenzijuServlet
 */
@WebServlet("/ObrisiRecenzijuServlet")
public class ObrisiRecenzijuServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ObrisiRecenzijuServlet() {
        super();
