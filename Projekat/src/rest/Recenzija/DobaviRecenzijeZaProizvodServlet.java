...
/**
 * Servlet implementation class DobaviRecenzijeZaProizvodServlet
 */
@WebServlet("/DobaviRecenzijeZaProizvodServlet")
public class DobaviRecenzijeZaProizvodServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DobaviRecenzijeZaProizvodServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Recenzija> recenzijeProizvoda=new ArrayList<Recenzija>();
		
		for(Recenzija k : recenzije){
			if(k.getSifraProizvoda().equals(temp.getNaslov()))
				recenzijeProizvoda.add(k);
		}
		
		String sArticles = mapper.writeValueAsString(recenzijeProizvoda);
